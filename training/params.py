...
def parse_args(args):
    ...
    parser.add_argument(
        "--drop_rate", type=float, default=0, help="Gradient clip."
    )
    parser.add_argument(
        "--aug_text", type=float, default=0, help="Gradient clip."
    )
    parser.add_argument(
        "--long_range", type=float, default=0, help="Gradient clip."
    )
    parser.add_argument(
        "--use_224",
        default=False,
        action="store_true",
        help='Resize 448 to 224.'
    )
